...
<html>
<head>
<link href="../binary/rules.css" rel="stylesheet" type="text/css"></head>
<title>Untitled Document</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
<body>
<p align="center">
<font color="blue" size="5">Administrater Login Page</font></p>
<br><br>
</p>
...
response.sendRedirect("yadminpage.jsp");
}
else if(k==0){
%>
...
<table width="100%" height="343">
  <tr>
    <td rowspan="2"></td>
    <td width="54%" height="148"><p align="left">
	<font color="blue">Content Designers, reviewers and administrable users, please login.
      </font></p>
	</td>
    <td width="32%" height="148">
    <b>Administrators login :- </b>
