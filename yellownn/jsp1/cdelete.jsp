...
<table width="782" height="119" border="0" align="center">
  <tr>
    <td width="772" valign="top"> <font size="6" color="#008000"> Customer Deletion Form</font>
<br>
...
<%
          ...
          int i=stmt.executeUpdate("delete from regis where t7='"+str+"'");
		  if(i>0)
		  out.println("<font size=+2 color=#990000>Customer deleted successfully</font>");
}%>

<br><br><br><br><br><br>

<p  align="left" class="style4 style5" ><u>Customer details</u></p>
<br />
<%
         Connection con=null;
          ResultSet rs=null;
...
<hr color="red">
<br><br>
<strong><font size="4" color="#008000"><u>Account Detail:-</u></font></strong>
<br>
<br>
<p align="center">
<%
