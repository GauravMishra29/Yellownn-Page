...
<%  Connection c;
	...
	try
	 ...
	 i=s.executeUpdate("insert into cservice values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"')");
    }
	 catch(Exception e)
	  {
	  out.println(e);
...
<table width="782" height="119" border="0" align="center">
  <tr>
    <td width="772" valign="top"> <P align="center"><font size="6" color="#FF0088"><u>Service Registration Form</u></font></p>
      <p align="right"><a href="ycentry.jsp"><u>back on customer entry page</u></a></p>
	  <p><font color="#008000">City of nawabs yellow page provide following services?<br />
      ...
      <table height="99" border="2" align="center" bgcolor="#CCCCCC">
        ...
        <tr>
          <td>information  sms </td>
          <td>01</td>
        </tr>
        <tr>
          <td>information E-mail</td>
          <td>02</td>
        </tr>
        <tr>
          <td>information postal service</td>
          <td>03</td>
        </tr>
      </table>
      <br />
